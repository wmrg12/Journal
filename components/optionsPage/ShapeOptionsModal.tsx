    ...
    >
        ...
        <View style={S.shapeOptionsContainer}>
          ...
          {/* Tipo de forma */}
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={S.shapeToolsRow} >
                {([
                ...
                ] as { id: ShapeType; label: string; icon: any }[]).map((shape) => (
                <TouchableOpacity
                    key={shape.id}
                    style={[
                ...
                >
                    <MaterialIcons name={shape.icon} size={22}  color={selectedShapeType === shape.id ? uiColors.gray : uiColors.black} />
